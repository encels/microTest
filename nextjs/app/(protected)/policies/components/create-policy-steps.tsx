...
import { FileText, LucideIcon, ShieldCheck, UserRound } from 'lucide-react';
...
export function CreatePolicySteps({ currentStep }: StepsProps) {
  ...
  const steps: IStepsItems = [
    ...
    {
      title: t('policies.create_policy.form_steps.step_titles.insured_data'),
      icon: UserRound,
    },
    {
      title: t(
        'policies.create_policy.form_steps.step_titles.coverages_conditions',
      ),
      icon: ShieldCheck,
    },
  ];
